 ...
 * @property {Array<TextQuestion | MultipleChoiceQuestion>} questions
 * @property {string} description
 * @property {string} category_name_hyphenated
 */

/**
 * @typedef {Object} TextQuestion
 * @property {"text"} question_type
 * @property {string} identifier
 * @property {string} headline
 * @property {string | null} description
 * @property {boolean} required
 * @property {string} multiline
 * @property {Array<any>} jumps
 */

/**
 * @typedef {Object} MultipleChoiceQuestion
 * @property {"multiple-choice"} question_type
 * @property {string} identifier
 * @property {string} headline
 * @property {string | null} description
 * @property {boolean} required
